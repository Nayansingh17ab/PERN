...
function AddElectronicsModal({ subcategory }) {
  const { addProduct, formData, setFormData, loading, subcategories } = useElectronicsStore();
        ...
        return (
          <div key={field} className="form-control">
            <label className="label cursor-pointer">
              <span className="label-text">Smart TV</span>
              <input
                type="checkbox"
                className="checkbox checkbox-primary"
                checked={formData.smart_tv || false}
                onChange={(e) => setFormData({ ...formData, smart_tv: e.target.checked })}
              />
            </label>
          </div>
        );
